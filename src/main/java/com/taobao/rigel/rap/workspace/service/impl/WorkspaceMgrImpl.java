        ...
        while (moduleIterator.hasNext()) {
            ...
            while (pageIterator.hasNext()) {
                ...
                while (actionIterator.hasNext()) {
                    ...
                    if (!actionA.getAuthor().equals(actionB.getAuthor())) {
                        boolean aChanged = (!actionA.getAuthor().equals(actionO.getAuthor()));
                        boolean bChanged = (!actionB.getAuthor().equals(actionO.getAuthor()));
                        ...
                        if (aChanged && bChanged) {
                            ...
                            // update
                            log.append(logTemplate(Integer.parseInt(new Integer(actionB.getId()).toString()), "action", "update",
                                    actionA.getAuthor(), actionB.getAuthor(), "author"));
                            actionB.setAuthor(actionA.getAuthor());
                        } else if (!aChanged && bChanged) {
                            // ignore
                        }
                    }
                    ...
                    if (!actionA.getVersion().equals(actionB.getVersion())) {
                        boolean aChanged = (!actionA.getVersion().equals(actionO.getVersion()));
                        boolean bChanged = (!actionB.getVersion().equals(actionO.getVersion()));
                        ...
                        if (aChanged && bChanged) {
                            ...
                            // update
                            log.append(logTemplate(Integer.parseInt(new Integer(actionB.getId()).toString()), "action", "update",
                                    actionA.getVersion(), actionB.getVersion(), "version"));
                            actionB.setVersion(actionA.getVersion());
                        } else if (!aChanged && bChanged) {
                            // ignore
                        }
                    }

                    if (!actionA.getStatus().equals(actionB.getStatus())) {
                        boolean aChanged = (!actionA.getStatus().equals(actionO.getStatus()));
                        boolean bChanged = (!actionB.getStatus().equals(actionO.getStatus()));
                        ...
                        if (aChanged && bChanged) {
                            ...
                            // update
                            log.append(logTemplate(Integer.parseInt(new Integer(actionB.getId()).toString()), "action", "update",
                                    actionA.getStatus(), actionB.getStatus(), "status"));
                            actionB.setStatus(actionA.getStatus());
                        } else if (!aChanged && bChanged) {
                            // ignore
                        }
                    }
