...
alter table tb_action add COLUMN status varchar(50);
alter table tb_action add COLUMN version varchar(50);
alter table tb_action add COLUMN author varchar(50);
